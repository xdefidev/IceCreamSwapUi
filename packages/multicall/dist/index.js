...
var MULTICALL_ADDRESS = {
  [sdk.ChainId.CORE]: "0x7bfaa2D0Dc774bA417877Be8252dcede580Ba287"
};
var DEFAULT_BLOCK_CONFLICT_TOLERANCE = 5;
var BLOCK_CONFLICT_TOLERANCE = constants.chains.reduce((acc, chain) => {
  return { ...acc, [chain.id]: DEFAULT_BLOCK_CONFLICT_TOLERANCE };
}, {});
var DEFAULT_GAS_LIMIT = 150000000n;
var DEFAULT_GAS_LIMIT_BY_CHAIN = constants.chains.reduce((acc, chain) => {
  return { ...acc, [chain.id]: DEFAULT_GAS_LIMIT };
}, {});
var DEFAULT_GAS_BUFFER = 3000000n;
var DEFAULT_GAS_BUFFER_BY_CHAIN = constants.chains.reduce((acc, chain) => {
